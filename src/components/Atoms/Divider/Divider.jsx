...
class Divider extends Component {
  ...
  animateComponentEvent() {
    ...
    window.addEventListener('scroll', function (ev) {
      var currentPosition = divider.getBoundingClientRect();
      var windowOffset = window.innerHeight * (offset / 100) - (currentPosition.height / 2) ;

      var percentage = (currentPosition.bottom - window.innerHeight) * 100 / windowOffset * -1;
