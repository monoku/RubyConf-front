...
class Divider extends Component {
  ...
  render() {
    ...
    return (
      <svg key={name} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="817px" height="36px" viewBox="0 0 817 36" version="1.1" id={name}>
        <defs>
          <linearGradient x1="0%" y1="0%" x2="100%" y2="0%" id={`linearGradient-1_${name}`} gradientUnits="userSpaceOnUse">
